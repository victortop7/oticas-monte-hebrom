...
const benefits = [
  ...
  },
  {
    ...
    desc: 'Trabalhamos com as melhores lentes: JR Light Vision e Marchal Light Easy HD.',
  },
]

export function Empresa() {
  const wa = whatsappLink(stores[0].whatsapp, 'empresas/convênios')
      ...
      <div className="container empresa-inner">
        ...
        <div>
          ...
          <a href={wa} target="_blank" rel="noreferrer"
            className="btn btn-white btn-lg" style={{ marginTop: 40 }}>
        ...
        <div className="empresa-img-wrap">
          <img src={img('empresa.png')} alt="Para sua Empresa — Óticas Monte Hebrom" />
          {/* Metrics overlay */}
          <div className="empresa-img-metrics">
            ...
            <div className="metric-box">
              ...
              <div className="metric-label">Modelos</div>
            </div>
          </div>
          <a href={wa} target="_blank" rel="noreferrer"
            className="btn btn-whatsapp empresa-img-cta">
            <WaSVG /> Quero o convênio
          </a>
        </div>
